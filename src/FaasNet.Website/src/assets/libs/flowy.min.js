var flowy = function (canvas, grab, release, snapping, rearrange, spacing_x, spacing_y) {
  ...
  flowy.load = function () {
    ...
    flowy.destroy = function () {
      ...
      document.removeEventListener("touchstart", touchblock);


      document.removeEventListener("mouseup", touchblock);
      document.removeEventListener("mousemove", flowy.moveBlock);
      document.removeEventListener("touchmove", flowy.moveBlock);

      document.removeEventListener("mouseup", flowy.endDrag);
      document.removeEventListener("touchend", flowy.endDrag);
    }
