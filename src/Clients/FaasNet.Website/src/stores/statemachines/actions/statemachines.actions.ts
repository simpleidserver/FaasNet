...
export const startSearch = createAction('[StateMachines] START_SEARCH_STATE_MACHINES', props<{ order: string, direction: string, count: number, startIndex: number, vpn: string }>());
...
export const startAddEmpty = createAction('[StateMachines] START_ADD_EMPTY_STATE_MACHINE', props<{ name: string, description: string, vpn: string }>());
...
export const startUpdate = createAction('[StateMachines] START_UPDATE_STATE_MACHINE', props<{ id: string, stateMachine: any }>());
export const completeUpdate = createAction('[StateMachines] COMPLETE_UPDATE_STATE_MACHINE', props<{ id: string }>());
