...
namespace FaasNet.EventMesh
{
    public partial class PartitionedEventMeshNode
    {
        ...
        {
            var vpn = await Query<GetVpnQueryResult>(PartitionNames.VPN_PARTITION_KEY, new GetVpnQuery { Id = addVpnRequest.Vpn}, cancellationToken);
            ...
            var result = await Send(PartitionNames.VPN_PARTITION_KEY, addVpnCommand, cancellationToken);
