...
namespace FaasNet.EventMesh
{
    public partial class PartitionedEventMeshNode
    {
        ...
        {
            var vpn = await Query<GetVpnQueryResult>(VPN_PARTITION_KEY, new GetVpnQuery { Id = updateEventDefinition.Vpn }, cancellationToken);
            ...
            var eventDef = await Query<GetEventDefinitionQueryResult>(EVENTDEFINITION_PARTITION_KEY, new GetEventDefinitionQuery { Id = updateEventDefinition.Id, Vpn = updateEventDefinition.Vpn }, cancellationToken);
            ...
            var result = await Send(EVENTDEFINITION_PARTITION_KEY, new UpdateEventDefinitionCommand { Id = updateEventDefinition.Id, JsonSchema = updateEventDefinition.JsonSchema, Vpn = updateEventDefinition.Vpn }, cancellationToken);
