...
namespace FaasNet.EventMesh
{
    public partial class PartitionedEventMeshNode
    {
        ...
        {
            var client = await Query<GetClientQueryResult>(CLIENT_PARTITION_KEY, new GetClientQuery { Id = helloRequest.ClientId }, cancellationToken);
            ...
            var addSessionCommand = new AddSessionCommand { Id = sessionId, ClientId = helloRequest.ClientId, ClientPurpose = helloRequest.Purpose, ExpirationTime = expirationTime, QueueName = helloRequest.QueueName };
