...
namespace FaasNet.EventMesh
{
    public partial class PartitionedEventMeshNode
    {
        public async Task<BaseEventMeshPackage> Handle(AddEventDefinitionRequest addEventDefinition, CancellationToken cancellationToken)
        {
            ...
            var addEventDefCmd = new AddEventDefinitionCommand { Id = addEventDefinition.Id, JsonSchema = addEventDefinition.JsonSchema, Vpn = addEventDefinition.Vpn, Description = addEventDefinition.Description, Topic = addEventDefinition.Topic };
